 ...
 * Languages List
 */
@ApiModel(description = "Languages List")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class LanguageList {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Total number of languages documents that matched your query.")
  ...
  **/
   ...
   * @return the LanguageList instance itself
   */
  public LanguageList putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.total, languageList.total) &&
        Objects.equals(this.languages, languageList.languages)&&
        Objects.equals(this.additionalProperties, languageList.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(total, languages, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to LanguageList
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LanguageList.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (int i = 0; i < jsonArraylanguages.size(); i++) {
        Language.validateJsonObject(jsonArraylanguages.get(i).getAsJsonObject());
      };
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<LanguageList>() {
           ...
           public LanguageList read(JsonReader in) throws IOException {
             ...
             LanguageList instance = thisAdapter.fromJsonTree(jsonObj);
