 ...
 * Error
 */
@ApiModel(description = "Error")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Error {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Server version number.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Error type. You can learn more about all the error types at https://appwrite.io/docs/error-codes#errorTypes")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(version, message, code, type, additionalProperties);
  }
