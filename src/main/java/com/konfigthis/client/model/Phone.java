 ...
 * Phone
 */
@ApiModel(description = "Phone")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Phone {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Phone code.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(code, countryCode, countryName, additionalProperties);
  }
