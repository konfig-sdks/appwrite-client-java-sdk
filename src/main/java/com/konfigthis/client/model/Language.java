 ...
 * Language
 */
@ApiModel(description = "Language")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Language {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Language two-character ISO 639-1 codes.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Language native name.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, code, nativeName, additionalProperties);
  }
