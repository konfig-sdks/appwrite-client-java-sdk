 ...
 * Sessions List
 */
@ApiModel(description = "Sessions List")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class SessionList {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Total number of sessions documents that matched your query.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "List of sessions.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.total, sessionList.total) &&
        Objects.equals(this.sessions, sessionList.sessions)&&
        Objects.equals(this.additionalProperties, sessionList.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(total, sessions, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SessionList
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SessionList.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
