...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://cloud.appwrite.io/v1";
    ...
    public ApiClient(OkHttpClient client, Configuration configuration) {
        ...
        authentications.put("Session", new ApiKeyAuth("header", "X-Appwrite-Session"));
        ...
        if (configuration != null) {
            if (configuration.jWT != null) {
                this.setJWT(configuration.jWT);
            }
            if (configuration.locale != null) {
                this.setLocale(configuration.locale);
            }
            if (configuration.project != null) {
                this.setProject(configuration.project);
            }
            if (configuration.session != null) {
                this.setSession(configuration.session);
            }
    ...
    public String getJWT() {
        return ((ApiKeyAuth) this.getAuthentication("JWT")).getApiKey();
    }

    public void setJWT(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("JWT")).setApiKey(apiKey);
    }

    public void setJWTPrefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("JWT")).setApiKeyPrefix(prefix);
    }
    public String getLocale() {
        return ((ApiKeyAuth) this.getAuthentication("Locale")).getApiKey();
    }

    public void setLocale(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("Locale")).setApiKey(apiKey);
    }

    public void setLocalePrefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("Locale")).setApiKeyPrefix(prefix);
    }
    public String getProject() {
        return ((ApiKeyAuth) this.getAuthentication("Project")).getApiKey();
    }

    public void setProject(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("Project")).setApiKey(apiKey);
    }

    public void setProjectPrefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("Project")).setApiKeyPrefix(prefix);
    }
    public String getSession() {
        return ((ApiKeyAuth) this.getAuthentication("Session")).getApiKey();
    }

    public void setSession(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("Session")).setApiKey(apiKey);
    }

    public void setSessionPrefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("Session")).setApiKeyPrefix(prefix);
    }
    ...
    private void init() {
        ...
        setUserAgent("Konfig/1.5.0/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://cloud.appwrite.io/v1)
